...
public class BarcodeTimer_isogi : MonoBehaviour
{
    ...
    private float countdownTime = 5f; // タイマーの制限時間
    public int FinSw = 0;
    ...
    private Score_isogi score_Isogi;
    ...
    public void StartTimer()
    {
            ...
            )
        {
            ...
            {
                // スクリプトAのインスタンスを取得
                score_Isogi = targetObject.GetComponent<Score_isogi>();
